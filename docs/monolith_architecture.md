...
- [Monolith Architecture Analysis](#monolith-architecture-analysis)
  - [1. JPA Entity Relationships & Cross-Domain Foreign Keys](#1-jpa-entity-relationships-cross-domain-foreign-keys)
  - [2. Cross-Domain Service and Repository Calls](#2-cross-domain-service-and-repository-calls)
  - [3. Synchronous In-Process Calls (To Become Async/REST)](#3-synchronous-in-process-calls-to-become-asyncrest)
